...
@section('title')
<title>USD | Update Announcement </title>
@endsection
@section('konten')
 <!-- Begin Page Content -->
                            ...
                            {{ method_field('PUT') }} 
                                 <div class="box-body">
                                     <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter Title here" name="judul" id="judul" value="{{$announcement->title}}" class="form-control">
                                            </div>
                                            @error('judul')
                                    ...
                                    <div class="form-group">
                                        <label for="content">Description</label>
                                         <textarea name="content" id="content_article"  rows="10" class="form-control">{{$announcement->content}}</textarea>
                                         @error('content')
                                ...
                                <div class="col-md-4">
                                    <div class="card-body">
                                        ...
                                        <label for="created_at">Update date</label>
                                        </div>
                                        <div class="box-body">
                                            <div class="form-group">
