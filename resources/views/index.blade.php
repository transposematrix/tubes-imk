...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="{{asset('template/assets/images/slider/usd.jpeg')}}" alt="First slide">
            <div class="carousel-caption d-none d-md-block">
                <h5 class=" bounceInDown">USU SOCIETY FOR DEBATING</h5>
                <p class=" bounceInLeft">Debaters are not born they are MADE</p>
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="{{asset('template/assets/images/slider/slide-03.jpg')}}" alt="Third slide">
...
<div class="container">
    ...
    <div class="event-ro row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="event-box">
                <img src="{{asset('template/assets/images/events/image_04.jpg')}}" alt="">
                <h4>Child Education in Africa</h4>
                <p class="raises"><span>Raised : $34,425</span> / $500,000 </p>
                <p class="desic">Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Lorem Ipsum has been the industry's </p>
                <button class="btn btn-success btn-sm">Donate Now</button>
...
<div class="container">
    ...
    <div class="row">
       <div class="col-lg-6 col-md-12">
            <img src="{{asset('template/assets/images/about.jpg')}}" alt="">
        </div>
        ...
        <div class="blog-row row">
            <div class="col-md-4 col-sm-6">
                <div class="single-blog">
                    <figure>
                        <img src="{{asset('template/assets/images/events/image_01.jpg')}}" alt="">
                    </figure>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-blog">
                    <figure>
                        <img src="{{asset('template/assets/images/events/image_02.jpg')}}" alt="">
                    </figure>
                    <div class="blog-detail">
                        <small>By Admin | August 10 2018</small>
                        <h4>Methods of Recuirtments</h4>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="single-blog">
                    <figure>
                        <img src="{{asset('template/assets/images/events/image_03.jpg')}}y" alt="">
                    </figure>
                    <div class="blog-detail">
                        <small>By Admin | August 10 2018</small>
                        <h4>Methods of Recuirtments</h4>
