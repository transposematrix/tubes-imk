...
<body style="background-image: url('{{asset('loginregister/img/bg_login.jpg')}}');">
                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" autofocus placeholder="Enter Password">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12 mb-3 mb-sm-0">
                                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" autofocus placeholder="Enter Repeat Password">
                                            </div>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="{{route('password.request')}}">Cancel reset!</a>
                                    </div>
                                    <div class="text-center">
