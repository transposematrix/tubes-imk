                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <div align="bottom" class="col-lg-5 "><center><br><img src="{{asset('loginregister/img/logo_usd.jpg')}}" width="290" alt=""></center></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"><b>LOGIN USD</b></h1>
                                    </div>
                                    ...
                                    @csrf
                                        <div class="form-group">
                                            <input type="email" name="email" value="{{old('email')}}" class="form-control form-control-user @error('email') is-invalid @enderror"
                                                ...
                                                @error('email')
                                                <span class="Invalid - feedback" rule="alert">
