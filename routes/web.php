...
Route::get('announcement-user', [AnnouncementController::class, 'list']);
route::get('/announcementDetails/{id}', [AnnouncementController::class, 'announcementUser'])->name('announcementPost');
...
Route::put('/absensi/updateUser/{id}', [absensiController::class, 'userUpdate']);
...
Route::post('add_g', [GatheringController::class, 'store'])->name('add_g');
Route::put('/g/update/{id}', [GatheringController::class, 'update']);
Route::get('/g/hapus/{id}', [GatheringController::class, 'destroy']);
use App\Http\Controllers\afterGlowController;
Route::get('afterglow-admin', [afterGlowController::class, 'list']);
route::get('/afterGlow', [afterGlowController::class, 'listAfter'])->name('afterGlow');
Route::post('add_ag', [afterGlowController::class, 'store'])->name('add_ag');
Route::put('/ag/update/{id}', [afterGlowController::class, 'update']);
Route::get('/ag/hapus/{id}', [afterGlowController::class, 'destroy']);
use App\Http\Controllers\AchievementController;
route::get('/achievement', [AchievementController::class, 'achievementList'])->name('achievement');
Route::get('achievement-admin', [AchievementController::class, 'list']);
Route::post('add_ac', [AchievementController::class, 'store'])->name('add_ac');
Route::put('/ac/update/{id}', [AchievementController::class, 'update']);
Route::get('/ac/hapus/{id}', [AchievementController::class, 'destroy']);